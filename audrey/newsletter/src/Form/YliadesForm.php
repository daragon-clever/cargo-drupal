...
use Drupal\Core\Form\drupal_set_message;//todo: changer le méthode
...
class YliadesForm extends FormBase
{
    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        $form['actions'] = [
            ...
            '#value' => $this->t("Send"),
            '#ajax' => [
                'callback' => '::setMessage'//todo: enlever ajax
            ]
        ];
    ...
    public function setMessage(array $form, FormStateInterface $formState)
    {
        //Initialize variables
        $email = $formState->getValue('mail');
        $choixMarques = $formState->getValue('marques');
