...
class MerchCieController extends AbstractCompanyController
{
    const ENTITY_ACTITO = "Merch et Cie";
    const TABLE_ACTITO = "MerchEtCie";
    ...
    public function setDataToSaveOnActito(array $dataUser): array
    {
        ...
        $dataForActito['firstName'] = $dataUser['prenom'];
        $dataForActito['lastName'] = $dataUser['nom'];
        $dataForActito['company'] = $dataUser['societe'];
        $dataForActito['source'] = "site-merch";
    ...
    private function setDataToInsertOrUpdatePeopleOnDb($arrayData): array
    {
        ...
        $dataToUpdate['company'] = $arrayData['societe'];
